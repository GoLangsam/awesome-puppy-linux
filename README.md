...
| [DpupStretch](http://oldforum.puppylinux.com/puppy/viewtopic.php?t=112125) | 32 bit    | Dec 2017     | Debian Stretch i686             |
...
| [TahrPup64](http://murga-linux.com/puppy/viewtopic.php?t=96748)    | 64 bit            | Dec 2014     | Ubuntu 14.04 LTS (Tahr) i686    |

More versions are available on the [official releases downloads page](http://puppylinux.com/download.html)

## Puppy derivatives:

- [Barebones Puppies](http://www.murga-linux.com/puppy/viewtopic.php?t=83841) - various stripped-down versions of Puppy Linux.
- [EasyOS](https://easyos.org/about/how-and-why-easyos-is-different.html) - created by Barry Kauler, the original creator and developer of Puppy Linux.
...
- [JWM](http://joewing.net/projects/jwm/) - lightweight window manager with taskbar and menus. ![Freeware][freeware icon]
- [JWM Desk](http://murga-linux.com/puppy/viewtopic.php?p=869688) - a GUI to manage and configure your JWM settings, themes, etc. ![Freeware][freeware icon]
- [OpenBox](http://openbox.org/wiki/Main_Page) - lightweight, minimalist window manager, often used with 3rd-party taskbars. ![Freeware][freeware icon]
- [LXDE](https://lxde.org/) - fast yet beautiful desktop environment. ![Freeware][freeware icon]
...
- [Leafpad](http://tarot.freeshell.org/leafpad/) - Leafpad is a simple, lightweight GTK+ text editor, designed to do the basics well.
- [Lighttable](http://lighttable.com/) -the next generation code editor! Support live coding. ![Freeware][freeware icon]
- [Sublime](https://www.sublimetext.com/) - One of the best text editor of all time. ![Freeware][freeware icon]
- [VSCode](https://code.visualstudio.com) - Visual Studio Code is a lightweight but powerful source code editor which runs on your desktop and is available for Windows, OS X and Linux. It comes with built-in support for JavaScript, TypeScript and Node.js and has a rich ecosystem of extensions for other languages (C++, C#, Python, PHP) and runtimes.![Freeware][freeware icon]
...
- [FreeCiv](http://freeciv.org/) - An open source remake of Sid Meier’s Civilization® 2, recognized as one of the greatest strategy franchises of all-time.
...
- [GIMP](https://www.gimp.org/downloads/) - GIMP is a freely distributed program for such tasks as photo retouching, image composition and image authoring![Freeware][freeware icon]
...
- [Midori](https://www.midori-browser.org/) - very small and lightweight WebKit based browser.![Freeware][freeware icon]
- [NetSurf](https://www.netsurf-browser.org/) - tiny browser, very fast, custom rendering engine, even works in the framebuffer.![Freeware][freeware icon]
- [Palemoon](https://www.palemoon.org/) - a lightweight browser, based on Firefox, minimal dependencies, low CPU and RAM usage.![Freeware][freeware icon]
...
- [Shutter](http://shutter-project.org/) - Shutter is a feature-rich screenshot program for Linux based operating systems such as Puppy. ![Freeware][freeware icon]
...
- [mlterm](https://sourceforge.net/projects/mlterm/) - lightweight terminal with great support for CJK, Arabic, etc, and good framebuffer and image-in-terminal support.
...
- [Remarkable](https://remarkableapp.github.io/) - Best Markdown editor in Linux.![Freeware][freeware icon]
...
2. [sc0ttj](https://github.com/sc0ttj)
3. ....
